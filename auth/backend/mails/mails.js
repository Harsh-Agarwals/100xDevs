import { resetPasswordMailTemplate, resetSuccessMailTemplate, verificationCodeTemplate } from './mailTemplates.js';
...
export const sendResetSuccessMail = async(userMail) => {
    userMail = [{
        email: userMail
    }]
    client.send({
